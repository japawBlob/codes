...
node_t* consolidation(node_t* root){
	...
	printf("GLOBAL PROBLEMS: %i numberOfNodes: %i\n", globalProblems, numberOfNodes);
...
int* treeToField(node_t* root){
	int* ret = malloc((numberOfNodes*sizeof(int))+sizeof(int));
