...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++										
ONE_SECOND_CONST EQU  0x150000			; neni to v zadnem pripade presna hodnota jedne sekundy, udelano zhruba
...
COUNTDOWN
				...
				; Rozhodnuti zda jiz nastal cas na blikani
				CMP 	R3, #STEADY_LIGHT_CONST
				
				BLT		LIGHT_IS_OFF
				
				; Test, zda svetlo sviti
				TST		R6, #0x1
...
LIGHT_IS_OFF
				...
				; Inkrementace pocitadla sekund a pripadny skok na zacatek, pokud nastal cas
				ADD		R3, R3, #0x1
