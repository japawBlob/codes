...
LOOP									; hlavni smycka programu, blikani LED a cteni stavu tlacitka			
				...
				MOV		R1, #0x0300		; Vlozeni hodnoty 0x100 do R1, konstanta pro nastaveni bitu 8 
				TST		R4, R3			; Porovnani R4 a R3 => (R4 & R3) a nastaveni priznaku
				;TEQ		R4, R3						; testuje se jestli je v R4 (citac) pozadovana hodnota
				...
				MOV		R1, #0x0000		; Vlozeni hodnoty 0x200 do R1, konstanta pro nastaveni bitu 9
LOOP1			
				...
				B LOOP2						; tj. skok na LOOP pri nestisknutem tlacitku, jinak se pokracuje
...
LOOP2									; hlavni smycka programu, blikani LED a cteni stavu tlacitka			
				...
				TST		R4, R3			; Porovnani R4 a R3 => (R4 & R3) a nastaveni priznaku
										...
										; tj. jeli nastaven urcity bit (hodnota v R3)
				BEQ		LOOP3			; Skok na navesti LOOP1, je-li vysledek predchozi operace roven 0
										; tj. skok na LOOP1	v pripade nerovnosti bitu na dane pozici
...
LOOP3			
				...
				TST		R1, #0x1		; Porovnani R1 a 1 => (R1 & 1) a nastaveni priznaku
										; testuje se jestli je v R1 (brana A) pozadovana hodnota
										; tj. jeli nastaven bit 0
				BEQ		LOOP2			; Skok na navesti LOOP, je-li vysledek predchozi operace roven 0
...
LOOP4									; hlavni smycka programu, blikani LED a cteni stavu tlacitka			
				...
				TST		R4, R3			; Porovnani R4 a R3 => (R4 & R3) a nastaveni priznaku
										; testuje se jestli je v R4 (citac) pozadovana hodnota
										; tj. jeli nastaven urcity bit (hodnota v R3)
				BEQ		LOOP5			; Skok na navesti LOOP1, je-li vysledek predchozi operace roven 0
										; tj. skok na LOOP1	v pripade nerovnosti bitu na dane pozici
...
LOOP5			
				...
				TST		R1, #0x1		; Porovnani R1 a 1 => (R1 & 1) a nastaveni priznaku
										; testuje se jestli je v R1 (brana A) pozadovana hodnota
										; tj. jeli nastaven bit 0
				BEQ		LOOP4			; Skok na navesti LOOP, je-li vysledek predchozi operace roven 0
										; tj. skok na LOOP pri nestisknutem tlacitku, jinak se pokracuje
				MOV		R0, #50			; Vlozeni hodnoty prodlevy do R0, tj. 50
				BL		DELAY
				MOV 	R3, #konst1
...
LOOP6									; hlavni smycka programu, blikani LED a cteni stavu tlacitka			

				ADD		R4,R4,#1		; R4 = R4 + 1, inkrementace citace o 1
				
				; Blikani LED, frekvence je dana registrem R3
				MOV		R1, #0x0200		; Vlozeni hodnoty 0x100 do R1, konstanta pro nastaveni bitu 8 
				TST		R4, R3			; Porovnani R4 a R3 => (R4 & R3) a nastaveni priznaku
										; testuje se jestli je v R4 (citac) pozadovana hodnota
										; tj. jeli nastaven urcity bit (hodnota v R3)
				BEQ		LOOP7			; Skok na navesti LOOP1, je-li vysledek predchozi operace roven 0
										; tj. skok na LOOP1	v pripade nerovnosti bitu na dane pozici
				MOV		R1, #0x0100		; Vlozeni hodnoty 0x200 do R1, konstanta pro nastaveni bitu 9
LOOP7			
				STR		R1, [R2]		; Zapis hodnoty v R1 na adresu v R2, nastaveni/nulovani bitu
				...
				TST		R1, #0x1		; Porovnani R1 a 1 => (R1 & 1) a nastaveni priznaku
										; testuje se jestli je v R1 (brana A) pozadovana hodnota
										; tj. jeli nastaven bit 0
				BEQ		LOOP6			; Skok na navesti LOOP, je-li vysledek predchozi operace roven 0
										; tj. skok na LOOP pri nestisknutem tlacitku, jinak se pokracuje
				MOV		R0, #50			; Vlozeni hodnoty prodlevy do R0, tj. 50
				BL		DELAY
