...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++										
ONE_SECOND_CONST EQU  0x180000	
HALF_SECOND_CONST EQU	0xC0000
STEADY_LIGHT_CONST EQU	0x5
MAX_LIGHT_CONST EQU 	0x8	
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++										
...
START			
				MOV		R3,#0			; Urcuje kolik sekund bude svetlo svitit predtim, nez zacne blikat
				MOV		R4,#0			; Vlozeni 0 do R4, nulovani citace (softwarový citac registr R4)
				
				MOV		R1, #0x0000	
				STR		R1, [R2]		; Zhasnuti obou diod
				MOV		R6, #0x0		; Registr indikujici, zda svetlo sviti, ci nikoliv
INIT				
...
COUNTDOWN
				; Test, zda-li byl mel byt obnoven odpocet
				LDR		R1, [R5]		
				TST		R1, #0x1
				
				BNE 	BUTTON_PRESSED
				
				; Inkrementace pocitadla + test, zdali uz ubehla sekunda
				ADD		R4,R4,#0x1
				MOV		R0, #ONE_SECOND_CONST
				CMP		R4, R0
				
				BLT		COUNTER_INCREMENT_SKIP
				
				;BL DO_A_BLIK
				
				; Inkrementace pocitani sekund, vynulovani pocitadla a test, zdali se ma uz zacit blikat
				MOV		R4, #0x0
				ADD		R3, R3, #0x1
				CMP		R3, #STEADY_LIGHT_CONST			; 
				BGT		BEFORE_BLINKING
				
COUNTER_INCREMENT_SKIP
...
SHORT_JUMP
				...
				; Reset pocitadel a test, zda svetlo sviti
				TST		R6, #0x1
...
LIGHT_IS_OFF_1
				...
				MOV		R6, #0x1
				ADD		R3, R3, #0x1
				CMP		R3, #MAX_LIGHT_CONST
				
				BGT		START
SKIP_1
				; Ulozeni hodnoty na propsani zmeny do ledek
				STR		R1, [R2]
				MOV		R4, #0
NOT_YET_SECOND_1		
				B		BUTTON_PRESSED
...
BLINKING		
				...
				; Inkrementace pocitadla sekund a pripadny skok na zacatek pri vyprseni limitu
				ADD		R3, R3, #0x1
				CMP		R3, #MAX_LIGHT_CONST
...
WAIT1			
				LDR		R2, =12500		; Vlozeni konstanty pro prodlevu do R2
...
DO_A_BLIK
				...
				MOV		R0, #0x50			; Vlozeni hodnoty prodlevy do R0, tj. 10
				BL		DELAY
