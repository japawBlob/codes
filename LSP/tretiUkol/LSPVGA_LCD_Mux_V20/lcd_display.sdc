...
create_generated_clock -name {*|ipll|altpll_component|auto_generated|pll1|clk[0]} -source [get_pins {*|ipll|altpll_component|auto_generated|pll1|inclk[0]}] -duty_cycle 50.000 -multiply_by 39 -divide_by 49 -master_clock {CLOCK_50} [get_pins {*|ipll|altpll_component|auto_generated|pll1|clk[0]}] 
...
set_clock_uncertainty -rise_from [get_clocks {CLOCK_50}] -rise_to [get_clocks {*|ipll|altpll_component|auto_generated|pll1|clk[0]}]  0.020  
set_clock_uncertainty -rise_from [get_clocks {CLOCK_50}] -fall_to [get_clocks {*|ipll|altpll_component|auto_generated|pll1|clk[0]}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {CLOCK_50}] -rise_to [get_clocks {*|ipll|altpll_component|auto_generated|pll1|clk[0]}]  0.020  
set_clock_uncertainty -fall_from [get_clocks {CLOCK_50}] -fall_to [get_clocks {*|ipll|altpll_component|auto_generated|pll1|clk[0]}]  0.020  
