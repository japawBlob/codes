...
;++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++										
konst1 EQU	0x100000					; direktiva EQU priradi vyrazu 'konst1' hodnotu 0x80000 
...
LOOP2									; hlavni smycka programu, blikani LED a cteni stavu tlacitka			
				...
				;CMP 	R4, R3			; testuje se jestli je v R4 (citac) pozadovana hodnota
				
				;BNE		LOOP1		; tj. jeli nastaven urcity bit (hodnota v R3)
