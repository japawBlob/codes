...
// animating many shapes on scene graph
// average FPS and RAM usage about the same
// CPU usage seems to be almost twice as much
// as the canvas based approach's showed in MainCanvas

public class MainShape extends Application {
