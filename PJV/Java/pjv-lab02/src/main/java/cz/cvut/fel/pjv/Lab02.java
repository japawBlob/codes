...
public class Lab02 {
   ...
   public void start(String[] args) {
       if(args.length != 0 && (args[0].equals('1') || args[0].equals('2') || args[0].equals('3') || args[0].equals('4'))){ 
           System.exit(0);
       } else {
       ...
       while(true){
           if((buff=input.getLine()).equals("")){
               ...
               if(numberCount>1){
                    ...
                    standardDeviation = Math.sqrt(standardDeviation/(numberCount));

                    System.out.printf("%2d %.3f %.3f\n", numberCount, average, standardDeviation);
               }
               break;
           }
           if(isDouble(buff)){
